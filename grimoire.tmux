...
tmux bind-key "$grimoire_key" run-shell "$HOME/.config/tmux/plugins/tmux-grimoire/scripts/cast_shpell.sh standard"
tmux bind-key "$ephemeral_grimoire_key" run-shell "$HOME/.config/tmux/plugins/tmux-grimoire/scripts/cast_shpell.sh ephemeral"
tmux bind-key "$grimoire_kill_key" run-shell "$HOME/.config/tmux/plugins/tmux-grimoire/scripts/cast_shpell.sh kill"

tmux bind-key "$grimoire_helper_key" \
  run-shell "$HOME/.config/tmux/plugins/tmux-grimoire/scripts/cast_shpell.sh ephemeral grimoire '$HOME/.config/tmux/plugins/tmux-grimoire/bin/logo'"
